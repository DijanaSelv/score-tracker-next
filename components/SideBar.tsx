...
import { addBoardGame, addPlayer, addSession } from "../lib/queries";
...
const SideBar = ({
  ...
  const resetForm = (
    formReference: React.RefObject<HTMLFormElement | null>,
  ) => {
    formReference.current?.reset();
    formReference == sessionFormRef &&
      setPlayerScores([
